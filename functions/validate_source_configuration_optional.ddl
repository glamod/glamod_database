CREATE OR REPLACE FUNCTION __INSERT_SCHEMA__.validate_source_configuration_optional()
    RETURNS trigger AS
    $BODY$
    DECLARE
        tmp_int integer;
    ...
    BEGIN
        ...
        END IF;
        INSERT INTO __INSERT_SCHEMA__.source_configuration_optional VALUES (NEW.*);
        RETURN NEW;
    EXCEPTION
...
CREATE TRIGGER __INSERT_SCHEMA__.validate_source_configuration_optional BEFORE INSERT ON
