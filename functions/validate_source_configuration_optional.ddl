CREATE OR REPLACE FUNCTION validate_source_configuration_optional()
    RETURNS trigger AS
    $BODY$
    DECLARE
        tmp_int integer;
    ...
    BEGIN
        ...
        END IF;
        INSERT INTO source_configuration_optional VALUES (NEW.*);
        RETURN NEW;
    EXCEPTION
...
FOR EACH ROW
    EXECUTE PROCEDURE validate_source_configuration_optional();
